...
namespace AtmaAuto
{
    public partial class Struk02 : Form
    {
        ...
        private void Struk02_Load(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@notrans", CekRiwayat.kode);
