...
namespace AtmaAuto
{
    public partial class TransaksiForm : Form
    {
        ...
        private void TransaksiForm_Load(object sender, EventArgs e)
        {
            ...
            setBtnDeactive();
            FillDGVKonsumen();
            if (TransaksiLanjutForm.notrans !=null)
            {
                ...
                while (reader.Read())
                {
                    if (TransaksiLanjutForm.idkonsave.ToString() == reader.GetString(0))
                    {
                ...
                notranssave = TransaksiLanjutForm.notrans;
                conn.Close();
                FillDGVKendaraan();
        ...
        private void clearken_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                TransaksiLanjutForm admin = new TransaksiLanjutForm();
                admin.Show();
                this.Hide();
